...
InformacionRician=reshape(InformacionCanal,n,1);%Reformulo el vector 
Producto=InformacionModulada.*InformacionRician;%Producto de hx
...
%Escenario 3
InformacionEcualizada=InformacionRuido2./InformacionRician;%Compensar con ecualizador
...
%Escenario 4
kfactor=10^(6/10);
BER4 = berfading(Eb_N0,'psk',M,1,kfactor);
...
xlabel('Eb/No')
ylabel('BER')
legend('Canal AWGN', 'Sin. Rician sin ecualizacion','Sim. Rician con ecualizacion','Teorico Rician');
